...
# from tavily import TavilyClient
# client = TavilyClient("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")
# response = client.search(
#     query="give court judgement on ndps cases where ganja was caught and offender was minor",
#     include_answer="advanced",
#     search_depth="advanced",
#     country="india",
#     include_domains=["https://www.casemine.com"]
# )
# print(response)